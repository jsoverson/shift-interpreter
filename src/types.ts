import { BindingIdentifier, IdentifierExpression, AssignmentTargetIdentifier, ForStatement, WhileStatement, ForOfStatement, ForInStatement, DoWhileStatement, Block, FunctionBody, FunctionDeclaration, FunctionExpression, Method, Getter, Setter, Statement, Expression, Super } from "shift-ast";
...
export type FrameNode = Script | Statement | Expression | Super | BlockType;
