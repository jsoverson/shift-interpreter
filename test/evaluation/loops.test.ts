...
describe("Loops", () => {
  describe("For Loops", () => {
    ...
    it("should support nested break statements", async () => {
      assertResult(await compare('let b = 0; for (let a = 1; a <= 2; a++) {for (let i = 1; i < 10; i++) {break; b++;}; b = b + a;} b;'))
    });
    ...
    it("should support nested continue statements", async () => {
      assertResult(await compare('let b = 0; for (let a = 1; a <= 2; a++) {for (let i = 1; i < 10; i++) {b++; continue; b++;}; b = b + a;} b;'))
    });  
  })
